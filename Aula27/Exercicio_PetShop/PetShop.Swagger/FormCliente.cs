...
namespace PetShop.Swagger
{
    public partial class FormCliente : Form
    {
        ...
        public FormCliente(IClienteService service)
        {
            InitializeComponent();
            _service = service;
        }
        ...
        {
            ClienteInserirViewModel clienteViewModel = new ClienteInserirViewModel();
        ...
        private void buttonExecutarInserir_Click(object sender, EventArgs e)
        {
            try
            {
                var clienteViewModel = JsonConvert.DeserializeObject<ClienteInserirViewModel>(textBoxEntradaInserir.Text);
